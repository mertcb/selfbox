...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t4 = claim_text(p_nodes, "Visit the ");
    			a = claim_element(p_nodes, "A", { href: true });
    			var a_nodes = children(a);
    			t5 = claim_text(a_nodes, "Svelte tutorial");
    			a_nodes.forEach(detach_dev);
    			t6 = claim_text(p_nodes, " to learn how to build Svelte apps.");
    		...
    		h: function hydrate() {
    			...
    			add_location(h1, file$1, 5, 4, 54);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$1, 6, 14, 91);
    			add_location(p, file$1, 6, 1, 78);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file$2, 5, 4, 60);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$2, 6, 14, 97);
    			add_location(p, file$2, 6, 1, 84);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file$2, 4, 0, 49);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    			append_dev(main, h1);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(nav, file$3, 11, 2, 220);
    			add_location(div, file$3, 15, 2, 301);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(main, file$3, 9, 0, 189);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
